...
@section('content')
    <div class="container">
        ...
        @endif
        <form action="{{route('mf.store')}}" method="post">
            @csrf
            <div class="form-group">
                <label for="nume">Denumirea</label>
                <input type="text" class="form-control" id="name" name="name" placeholder="Denumirea MF" required>
                <small id="numeHelp" class="form-text text-muted">Adaugati denumirea MF</small>
            </div>
            <div class="form-group">
